...
class CustomWebviewWidget extends ConsumerStatefulWidget {
  const CustomWebviewWidget({super.key});

  @override
  ConsumerState<CustomWebviewWidget> createState() =>
      _CustomWebviewWidgetState();
}

class _CustomWebviewWidgetState extends ConsumerState<CustomWebviewWidget> {
